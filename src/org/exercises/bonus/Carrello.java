...
//             Ridimensiono l'array se necessario
            ...
            //Gestione carta fedelta'
            System.out.println("Possiedi una carta fedeltà? (si/no):");
            String risposta = scanner.nextLine().toLowerCase();

            boolean tesseraFedelta = risposta.equals("si");
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (tesseraFedelta) {
                    prezzoProdotto = carrello[i].calcolaPrezzoScontato(true);
                } else {
                    prezzoProdotto = carrello[i].getPrezzoBase();
                }
                totaleCarrello += prezzoProdotto;
            }

            System.out.println("Totale del carrello: " + totaleCarrello + "€");
        }
